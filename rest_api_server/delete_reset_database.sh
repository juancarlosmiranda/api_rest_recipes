...
echo "-------------------------------------"
find . -path "./broadcast.db.sqlite3"  -delete
...
echo "-------------------------------------"
echo $SERVER_REST_API_F'src/initial_data_values/group_values.json'
echo $SERVER_REST_API_F'src/initial_data_values/users_values.json'
echo $SERVER_REST_API_F'src/initial_data_values/oauth2_provider.json'
echo $SERVER_REST_API_F'src/initial_data_values/broadcast_config.json'
echo $SERVER_REST_API_F'src/initial_data_values/broadcast_messages.json'
